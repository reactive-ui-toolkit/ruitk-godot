...
const _VOCAB_GEN = preload("res://addons/reactive_ui_toolkit/guitkx/guitkx_vocabulary.gen.gd")
...
const _VOCAB_PATH_DEFAULT := "res://addons/reactive_ui_toolkit/guitkx/vocabulary.json"
...
static func _load_vocabulary() -> Dictionary:
	...
	if _VOCAB_PATH.is_empty() or _VOCAB_PATH == _VOCAB_PATH_DEFAULT:
		...
		if not _vocab_hold:
			_vocab_hold = true
			push_error("[guitkx] guitkx_vocabulary.gen.gd is not the expected shape -- regenerate it: godot --headless --path . --script res://addons/reactive_ui_toolkit/dev/gen_vocabulary.gd")
		return {}
