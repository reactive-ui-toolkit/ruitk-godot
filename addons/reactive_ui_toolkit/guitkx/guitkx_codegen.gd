...
const RGConfig = preload("res://addons/reactive_ui_toolkit/guitkx/guitkx_config.gd")
const RGResolve = preload("res://addons/reactive_ui_toolkit/guitkx/guitkx_resolve.gd")
...
const _COMPILER_SOURCES := [
	"res://addons/reactive_ui_toolkit/guitkx/guitkx.gd",
	"res://addons/reactive_ui_toolkit/guitkx/guitkx_markup.gd",
	"res://addons/reactive_ui_toolkit/guitkx/guitkx_lexer.gd",
	"res://addons/reactive_ui_toolkit/guitkx/guitkx_jsx_scan.gd",
	"res://addons/reactive_ui_toolkit/guitkx/guitkx_diag.gd",
	"res://addons/reactive_ui_toolkit/guitkx/vocabulary.json",
	"res://addons/reactive_ui_toolkit/guitkx/guitkx_vocabulary.gen.gd",
]
