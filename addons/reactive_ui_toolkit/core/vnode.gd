...
var children: Array = []         ## Array[RuitkVNode].
...
static func make_host(p_type: String, p_props, p_children, p_key = null) -> RuitkVNode:
...
static func make_component(p_component: Callable, p_props, p_children, p_key = null) -> RuitkVNode:
	var n := RuitkVNode.new()
...
static func make_fragment(p_children, p_key = null) -> RuitkVNode:
	var n := RuitkVNode.new()
...
static func make_portal(p_target: Node, p_children, p_key = null) -> RuitkVNode:
	var n := RuitkVNode.new()
	n.kind = Kind.PORTAL
...
static func make_error_boundary(p_props, p_children, p_key = null) -> RuitkVNode:
	var n := RuitkVNode.new()
