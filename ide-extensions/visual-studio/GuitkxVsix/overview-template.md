# Reactive UI Toolkit — Godot - VS2022 (GUITKX)

Editor support for **`.guitkx`**, the JSX-like markup of [Reactive UI Toolkit — Godot](https://github.com/reactive-ui-toolkit/ruitk-godot) — a React-style reactive UI library for Godot 4.x.
